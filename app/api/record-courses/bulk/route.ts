  ...
  try {
    ...
    for (const course of insertedCourses) {
      try {
        ...
        console.error(`[POSTBulkRecordCourses] Audit logging failed for course ${course.id}:`, auditErr);
      }
    }
    ...
    console.error("[POSTBulkRecordCourses] error:", err);
    const msg = err instanceof Error ? err.message : "Failed to bulk create record courses";
