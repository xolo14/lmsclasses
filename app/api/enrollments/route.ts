...
export async function GET(request: Request) {
  ...
  const data = rows.map((r) => {
    ...
    return {
      ...
      lmsId: r.studentLmsId,
      phone: r.studentPhone,
      collegeName: r.studentCollegeName,
      isActive: r.studentIsActive,
      organisationId: r.studentOrganisationId,
      enrollmentSource: r.enrollment.enrollmentSource,
      orgName: r.orgName,
